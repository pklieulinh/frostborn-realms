    ...
    public class DevSpawner : MonoBehaviour {
        ...
        void Start() {
            ...
            for (int i = 0; i < citizenCount; i++) {
                ...
                em.SetComponentData(e, new Needs { Hunger = 100, Warmth = 100, Morale = 100, Fatigue = 0 });
                em.SetComponentData(e, new Movement { Target = target, Speed = baseSpeed + UnityEngine.Random.Range(-0.5f, 1.5f) });
                em.SetComponentData(e, new DoctrineState { ActiveDoctrineA = 1, ActiveDoctrineB = 0 });
            }
